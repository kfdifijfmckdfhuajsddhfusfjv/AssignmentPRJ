...
@MultipartConfig(
        fileSizeThreshold = 1024 * 1024 * 1, // 1 MB: Giới hạn kích thước tối thiểu của file (dùng bộ nhớ tạm)
        maxFileSize = 1024 * 1024 * 1000, // 10 MB: Giới hạn kích thước tối đa của file tải lên
...
public class CVupload extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cvDAO.insert(cv);
//        request.getRequestDispatcher("cvManager").forward(request, response);
